Feature: Bookcategory
  ...
  Scenario Outline: I Should be abel to see list of terms of each filter
  ...
  Scenario Outline: I should be able to choose any filter option with specific result
    ...
    |Sort by              | Name: Z to A            | sorted product with the product name in alphabetical odrer z to a |
